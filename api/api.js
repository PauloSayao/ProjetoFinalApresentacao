...
const produtos = [
  {
    ...
    descricao: 'Deliciosa trufa recheada com ganache de chocolate.',
    quantity: 1,
    ativo: true
  },
  {
...
app.post("/pedidos", (req, res) => {
  const { produtos, nome, telefone, pagamento } = req.body;

  if (!produtos || !Array.isArray(produtos) || !nome || !telefone || !pagamento) {
